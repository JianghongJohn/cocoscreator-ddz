(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Poker.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '74e2fJnhjdJO4vBGihRWeu1', 'Poker', __filename);
// Script/Poker.js
...
cc.Class({
    ...
    creatCard: function creatCard(id) {
        this._cardId = id;
     ...
     */
    getBigType: function getBigType(id) {
        var bigType = null;
        if (id >= 1 && id <= 13) {
     ...
     */
    getSmallType: function getSmallType(id) {
        if (id < 1 || id > 54) {
     ...
     * @return 牌的小类型 
     */
    numToType: function numToType(num) {
        var type = null;
        switch (num) {
            case 0:
     ...
     * @return 图片的名字 
     */
    getImageName: function getImageName(id) {
        // 得到图片的前一个字符，表示是第几个牌  
        var imageName = "";
