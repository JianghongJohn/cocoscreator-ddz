(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/CardsType.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd6022BOKilJHYWQTIeKQzGF', 'CardsType', __filename);
// Script/CardsType.js
...
cc.Class({
     ...
     */
    isDuiZi: function isDuiZi(myCards) {
        // 默认不是对子  
        var flag = false;
     ...
     */
    isSanDaiYi: function isSanDaiYi(myCards) {
        var flag = -1;
        // 默认不是3带1  
     ...
     */
    isSanBuDai: function isSanBuDai(myCards) {
        // 默认不是3不带  
        var flag = false;
     ...
     */
    isShunZi: function isShunZi(myCards) {
        // 默认是顺子  
        var flag = true;
     ...
     */
    isZhaDan: function isZhaDan(myCards) {
        // 默认不是炸弹  
        var flag = false;
     ...
     */
    isDuiWang: function isDuiWang(myCards) {
        // 默认不是对王  
        var flag = false;
     ...
     */
    isLianDui: function isLianDui(myCards) {
        // 默认是连对  
        var flag = true;
        if (myCards == null) {
            flag = false;
    ...
    /** 
      ...
      */
    isFeiJi: function isFeiJi(myCards) {
        var flag = false;
        // 默认不是单  
        if (myCards != null) {
    ...
    /** 
      ...
      */
    isFeiJiBuDai: function isFeiJiBuDai(myCards) {
        if (myCards == null) {
            return false;
        }
        ...
        for (var i = 0; i < n - 1; i++) {
            ...
            if (grades[i + 1] - grades[i] != 1) {
                System.out.println("等级连续,如 333444" + (grades[i + 1] - grades[i]));
    ...
    /** 
        ...
        */
    isFeiJiDai: function isFeiJiDai(myCards) {
        var size = myCards.length;
    ...
    /** 
       ...
       */
    isSiDaiEr: function isSiDaiEr(myCards) {
        var flag = false;
